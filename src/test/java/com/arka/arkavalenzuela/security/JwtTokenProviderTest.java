package com.arka.arkagabriel.security;
...
class JwtTokenProviderTest {
    ...
    @BeforeEach
    void setUp() {
        // Set test values using reflection to avoid Spring injection issues
    ...
    @Test
    void getUsernameFromJwtToken_WithValidToken_ShouldExtractUsername() {
        // Given
