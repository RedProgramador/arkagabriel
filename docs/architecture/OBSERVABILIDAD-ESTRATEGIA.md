    ...
    rules:
      - alert: HighCPUUsage
        ...
        annotations:
          ...
          runbook: "https://runbooks.arkagabriel.com/cpu-high"
    ...
    rules:
      - alert: ServiceDown
        ...
        annotations:
          ...
          runbook: "https://runbooks.arkagabriel.com/service-down"
    ...
    rules:
      ...
      - alert: HighSalesVolume
        ...
        annotations:
          ...
          runbook: "https://runbooks.arkagabriel.com/high-traffic"
      ...
      - alert: AnniversarySalesSpike
        ...
        annotations:
          ...
          runbook: "https://runbooks.arkagabriel.com/anniversary-scenario"
    ...
    rules:
      - alert: ShippingServiceDown
        ...
        annotations:
          ...
          runbook: "https://runbooks.arkagabriel.com/shipping-down"
...
data:
  scenario.md: |
    ...
    ```
    URL: https://grafana.arkagabriel.com/d/anniversary
    Panels:
